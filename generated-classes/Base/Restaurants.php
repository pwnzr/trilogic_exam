 ...
 */
abstract class Restaurants implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\RestaurantsTableMap';
    ...
    /**
     * Initializes internal state of Base\Restaurants object.
     */
    ...
    /**
     * Compares this with another <code>Restaurants</code> instance.  If
     * <code>obj</code> is an instance of <code>Restaurants</code>, delegates to
     * <code>equals(Restaurants)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Restaurants The current object, for fluid interface
     */
     ...
     * @return $this|\Restaurants The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[RestaurantsTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[RestaurantsTableMap::COL_NAME] = true;
        }
    ...
    public function setLat($v)
    {
        ...
        if ($this->lat !== $v) {
            $this->lat = $v;
            $this->modifiedColumns[RestaurantsTableMap::COL_LAT] = true;
        }
    ...
    public function setLng($v)
    {
        ...
        if ($this->lng !== $v) {
            $this->lng = $v;
            $this->modifiedColumns[RestaurantsTableMap::COL_LNG] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : RestaurantsTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : RestaurantsTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : RestaurantsTableMap::translateFieldName('Lat', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lat = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : RestaurantsTableMap::translateFieldName('Lng', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = RestaurantsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Restaurants'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildRestaurantsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Restaurants::setDeleted()
     * @see Restaurants::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildRestaurantsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RestaurantsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(RestaurantsTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(RestaurantsTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(RestaurantsTableMap::COL_LAT)) {
            $modifiedColumns[':p' . $index++]  = 'lat';
        }
        if ($this->isColumnModified(RestaurantsTableMap::COL_LNG)) {
            $modifiedColumns[':p' . $index++]  = 'lng';
        }

        $sql = sprintf(
            'INSERT INTO restaurants (%s) VALUES (%s)',
    ...
    {
        $pos = RestaurantsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Restaurants'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Restaurants'][$this->hashCode()] = true;
        $keys = RestaurantsTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getLat(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RestaurantsTableMap::COL_ID)) {
            $criteria->add(RestaurantsTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(RestaurantsTableMap::COL_NAME)) {
            $criteria->add(RestaurantsTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(RestaurantsTableMap::COL_LAT)) {
            $criteria->add(RestaurantsTableMap::COL_LAT, $this->lat);
        }
        if ($this->isColumnModified(RestaurantsTableMap::COL_LNG)) {
            $criteria->add(RestaurantsTableMap::COL_LNG, $this->lng);
        }
    ...
    {
        $criteria = ChildRestaurantsQuery::create();
        $criteria->add(RestaurantsTableMap::COL_ID, $this->id);
     ...
     * If this ChildRestaurants is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildRestaurants The current object (for fluent API support)
     */
    public function setOrderss(Collection $orderss, ConnectionInterface $con = null)
    {
        ...
        foreach ($orderssToDelete as $ordersRemoved) {
            $ordersRemoved->setRestaurants(null);
        }
     ...
     * Otherwise if this Restaurants is new, it will return
     * an empty collection; or if this Restaurants has previously
     * been saved, it will retrieve related Orderss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Restaurants.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildOrders[] List of ChildOrders objects
     */
    public function getOrderssJoinAddresses(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOrdersQuery::create(null, $criteria);
        $query->joinWith('Addresses', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(RestaurantsTableMap::DEFAULT_STRING_FORMAT);
    }
