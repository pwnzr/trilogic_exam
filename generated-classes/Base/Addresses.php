 ...
 */
abstract class Addresses implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\AddressesTableMap';
    ...
    /**
     * Initializes internal state of Base\Addresses object.
     */
    ...
    /**
     * Compares this with another <code>Addresses</code> instance.  If
     * <code>obj</code> is an instance of <code>Addresses</code>, delegates to
     * <code>equals(Addresses)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Addresses The current object, for fluid interface
     */
     ...
     * @return $this|\Addresses The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AddressesTableMap::COL_ID] = true;
        }
    ...
    public function setAddress($v)
    {
        ...
        if ($this->address !== $v) {
            $this->address = $v;
            $this->modifiedColumns[AddressesTableMap::COL_ADDRESS] = true;
        }
    ...
    public function setLat($v)
    {
        ...
        if ($this->lat !== $v) {
            $this->lat = $v;
            $this->modifiedColumns[AddressesTableMap::COL_LAT] = true;
        }
    ...
    public function setLng($v)
    {
        ...
        if ($this->lng !== $v) {
            $this->lng = $v;
            $this->modifiedColumns[AddressesTableMap::COL_LNG] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AddressesTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AddressesTableMap::translateFieldName('Address', TableMap::TYPE_PHPNAME, $indexType)];
            $this->address = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AddressesTableMap::translateFieldName('Lat', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lat = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AddressesTableMap::translateFieldName('Lng', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = AddressesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Addresses'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAddressesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Addresses::setDeleted()
     * @see Addresses::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAddressesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AddressesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[AddressesTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . AddressesTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(AddressesTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AddressesTableMap::COL_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'address';
        }
        if ($this->isColumnModified(AddressesTableMap::COL_LAT)) {
            $modifiedColumns[':p' . $index++]  = 'lat';
        }
        if ($this->isColumnModified(AddressesTableMap::COL_LNG)) {
    ...
    {
        $pos = AddressesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Addresses'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Addresses'][$this->hashCode()] = true;
        $keys = AddressesTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(AddressesTableMap::DATABASE_NAME);

        if ($this->isColumnModified(AddressesTableMap::COL_ID)) {
            $criteria->add(AddressesTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AddressesTableMap::COL_ADDRESS)) {
            $criteria->add(AddressesTableMap::COL_ADDRESS, $this->address);
        }
        if ($this->isColumnModified(AddressesTableMap::COL_LAT)) {
            $criteria->add(AddressesTableMap::COL_LAT, $this->lat);
        }
        if ($this->isColumnModified(AddressesTableMap::COL_LNG)) {
            $criteria->add(AddressesTableMap::COL_LNG, $this->lng);
        }
    ...
    {
        $criteria = ChildAddressesQuery::create();
        $criteria->add(AddressesTableMap::COL_ID, $this->id);
     ...
     * If this ChildAddresses is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildAddresses The current object (for fluent API support)
     */
    public function setOrderss(Collection $orderss, ConnectionInterface $con = null)
    {
        ...
        foreach ($orderssToDelete as $ordersRemoved) {
            $ordersRemoved->setAddresses(null);
        }
     ...
     * Otherwise if this Addresses is new, it will return
     * an empty collection; or if this Addresses has previously
     * been saved, it will retrieve related Orderss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Addresses.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildOrders[] List of ChildOrders objects
     */
    public function getOrderssJoinUser(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOrdersQuery::create(null, $criteria);
     ...
     * @return ObjectCollection|ChildOrders[] List of ChildOrders objects
     */
    public function getOrderssJoinRestaurants(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOrdersQuery::create(null, $criteria);
        $query->joinWith('Restaurants', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(AddressesTableMap::DEFAULT_STRING_FORMAT);
    }
